...
💼 LinkedIn — Kevin Cusnir
🐙 GitHub — LiriothTeltanion
...
📂 Explorar el archivo de aprendizaje
---
...
<div dir="rtl">
<h2>👋 קצת עליי</h2>
<p>אני <strong>Kevin Cusnir</strong>, מפתח Full-Stack המתגורר בישראל. <strong>Lirioth Teltanion</strong> היא הזהות היצירתית שלי — השם שבו אני משתמש לפרויקטים דמיוניים, גיימינג, סיפורים אינטראקטיביים, מוזיקה וניסויים טכנולוגיים.</p>
<p>עברתי הכשרה בפיתוח Full-Stack ב-<strong>Developers Institute בשנת 2025</strong>, וכיום אני מתמקד בהפיכת רעיונות שאפתניים ונתונים מורכבים לתוכנה ברורה, שימושית ומלאת חיים.</p>
<ul>
...
<p>הוא מתעד את ההתקדמות שלי מהיסודות ועד ליישומים שלמים יותר, ושומר את העבודה שבנתה את הבסיס הטכני שלי.</p>
...
<p>הפרויקטים האלה הם חלק מההתפתחות שלי. אני משאיר את העבודה החזקה ביותר גלויה, ושומר את הניסויים המוקדמים בגלל הלקחים, הדפוסים והרעיונות שעוד יכולים להתפתח.</p>
<h2>🧰 מיומנויות וכלים</h2>
<p><strong>שפות:</strong> Python · TypeScript · JavaScript · SQL</p>
...
<p><strong>נתונים:</strong> SQLite · JSON · CSV · טרנספורמציה ואימות נתונים</p>
...
<h2>🤝 יצירת קשר</h2>
<p>אני פתוח לתפקידי ג'וניור ב-Full-Stack וב-Frontend, לשיתופי פעולה ולפרויקטים משמעותיים בטכנולוגיה יצירתית.</p>
<ul>
...
<div align="center">
<img src="https://skillicons.dev/icons?i=react,ts,js,python,nodejs,express,html,css,tailwind,vite,sqlite,postgres,git,github,githubactions,vscode,powershell&perline=9" alt="Technology icons" />
...
<img src="https://img.shields.io/badge/SQLite-0F172A?style=for-the-badge&logo=sqlite&logoColor=3EA6E8" alt="SQLite" />
<img src="https://img.shields.io/badge/Vitest-1F2937?style=for-the-badge&logo=vitest&logoColor=6E9F18" alt="Vitest" />
