# Profile 2.6.0 — Living Archive Clarity Edition 🌍✨
...
- Profile `2.6.0` released metadata and changelog;
...
- Nova Music Lab 1.6.0 Living Artist Atlas spotlight with manifest-pinned
...
- refreshed Nova Music Lab 1.6.0 social preview from its audited release bundle;
- migration guide.
